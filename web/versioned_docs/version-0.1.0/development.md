...
[`CONTRIBUTING.md`](https://github.com/fyannk/pgObjectStoreViewer/blob/v0.1.0/CONTRIBUTING.md),
and the complete normative rules for human and automated contributors are in
[`AGENTS.md`](https://github.com/fyannk/pgObjectStoreViewer/blob/v0.1.0/AGENTS.md).
