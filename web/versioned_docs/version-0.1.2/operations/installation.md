...
docker run --rm -p 3000:3000 \
  ...
  ghcr.io/fyannk/pgobjectstoreviewer:v0.1.2
```
...
[`deploy/kubernetes-example.yaml`](https://github.com/fyannk/pgObjectStoreViewer/blob/v0.1.2/deploy/kubernetes-example.yaml)
